  ...
  return (
    <Wrapper>
      <div className="section-center">
        <h3>Join our Newsletter for Future Updates</h3>
        <div className="content">
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam quis
            obcaecati minus, autem ipsam cupiditate eum ratione vero praesentium
            officiis adipisci distinctio ducimus ipsa numquam cum consectetur
